...
public class MybatisConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(DataSource dataSource, // DB 커넥션풀
    ...
    sqlSessionFactoryBean.setTypeAliasesPackage("international.domain");
    sqlSessionFactoryBean.setMapperLocations(//
        // Spring IoC 컨테이너를 통해 SQL 맵퍼 파일의 위치 정보를 가져온다.
        appCtx.getResources("classpath:international/mapper/*Mapper.xml"));
